...
# midr ![](man/figures/logo.png){align="right" height="114"}
...
The basic concepts underlying the package were developed as a functional decomposition technique called *Maximum Interpretation Decomposition* (MID). For the theoretical details of MID, see Iwasawa and Matsumori (2024).
