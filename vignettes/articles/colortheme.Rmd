...
You can get a pre-defined "color.theme" object by providing a theme name to the `color.theme()` function.
...
Alternatively, you can create a new "color.theme" object by passing a custom color vector or function to the first argument of `color.theme()`.
