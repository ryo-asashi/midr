...
pkgs <- c("mlbench", "gridExtra", "ggplot2", "Metrics", "khroma", "earth",
...
For each model type, we fit a target regression model and its surrogate MID model using the `train` data of 2000 observations.
We then evaluate the predictive accuracy of the target model and the *fidelity* of the surrogate model using RMSE.
