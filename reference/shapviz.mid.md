...
`shapviz.mid()` is an S3 method for the `shapviz::shapviz()` generic,
which calculates MID-derived Shapley values from a fitted MID model.
This method is dynamically registered when the **shapviz** package is
loaded.
